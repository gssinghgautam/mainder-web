...
jQuery(document).ready(function() {
    ...
    jQuery(document).on("click", ".deleteFloors", function() {
        ...
        if (confirmation) {
            jQuery.ajax({
                ...
                currentRow.parents('tr').remove();
                if (data.status == true) { alert("Floor successfully deleted"); } else if (data.status == false) { alert("Floor deletion failed"); } else { alert("Access denied..!"); }
            });
        }
    });
    ...
    jQuery(document).on("click", ".deleteRoomSize", function() {
        ...
        if (confirmation) {
            jQuery.ajax({
                ...
                currentRow.parents('tr').remove();
                if (data.status == true) { alert("Room Size successfully deleted"); } else if (data.status == false) { alert("Room Size deletion failed"); } else { alert("Access denied..!"); }
            });
        }
    });
    ...
    jQuery(document).on("click", ".deleteRoom", function() {
        ...
        if (confirmation) {
            jQuery.ajax({
                ...
                currentRow.parents('tr').remove();
                if (data.status == true) { alert("Room successfully deleted"); } else if (data.status == false) { alert("Room deletion failed"); } else { alert("Access denied..!"); }
            });
        }
    });
    ...
    jQuery(document).on("click", ".deleteCustomer", function() {
        ...
        if (confirmation) {
            jQuery.ajax({
                ...
                currentRow.parents('tr').remove();
                if (data.status == true) { alert("Customer successfully deleted"); } else if (data.status = false) { alert("Customer deletion failed"); } else { alert("Access denied..!"); }
            });
        }
    });
    jQuery(document).on("click", ".deleteBooking", function() {
        ...
        var confirmation = confirm("Are you sure to delete this Booking Info ?");
        ...
        if (confirmation) {
            jQuery.ajax({
                ...
                currentRow.parents('tr').remove();
                if (data.status == true) { alert("Booking Info successfully deleted"); } else if (data.status = false) { alert("Booking Info deletion failed"); } else { alert("Access denied..!"); }
            });
        }
    });
