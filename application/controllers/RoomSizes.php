...
class RoomSizes extends BaseController
{
    ...
    function roomSizesListing()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Sanatan Dharm : Puja Listing';
    ...
    function addNewRoomSize()
    {
        ...
        {
            $this->global['pageTitle'] = 'Sanatan Dharm  : Add New Puja';
    ...
    function addedNewRoomSize()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if($result > 0)
                {
                    $this->session->set_flashdata('success', 'New Puja created successfully');
                }
                else
                {
                    $this->session->set_flashdata('error', 'Puja creation failed');
                }
    ...
    function editOldRoomSize($roomSizeId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Sanatan Dharm : Edit Puja';
    ...
    function updateOldRoomSize()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    $this->session->set_flashdata('error', 'Puja updation failed');
                }
