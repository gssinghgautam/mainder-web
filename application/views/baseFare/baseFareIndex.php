...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      Puja Price Management
        ...
        <span class='pull-right'><a class="btn btn-primary" href="<?php echo base_url(); ?>addNewPujaPrice"><i class="fa fa-plus" aria-hidden="true"></i> Add New Puja Price</a></span>
      </h1>
    </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Puja Price List</h3>
                    <div class="box-tools">
