<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <span class='pull-right'><a class="btn btn-primary" href="<?php echo base_url(); ?>addNewPujaType"><i class="fa fa-plus" aria-hidden="true"></i> Add New Puja</a></span>
      </h1>
    </section>
