...
class BaseFare extends BaseController
{
    ...
    function baseFareListing()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Sanatan Dharm : Base Fare Listing';
    ...
    function addNewBaseFare()
    {
        ...
        {
            $this->global['pageTitle'] = 'Sanatan Dharm : Add New Base Fare';
            $this->load->model("rooms_model");
            $data['roomSizes'] = $this->rooms_model->getRoomSizes();
    ...
    function editOldBaseFare($bfId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Sanatan Dharm : Edit Base Fare';
