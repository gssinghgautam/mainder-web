          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu menu-open">
                 <li>
                  <a href="<?php echo base_url(); ?>eventsListing" >
                    <i class="fa fa-circle-o"></i>Events Listing
                  </a>
                </li>
                <!-- <li>
                  <a href="<?php echo base_url(); ?>roomListing" >
                    <i class="fa fa-circle-o"></i> Reject Booking List 
                  </a>
                </li> --> 
                <li>
                  <a href="<?php echo base_url(); ?>poojaListing" >
                    <i class="fa fa-circle-o"></i> Pooja Listing
                  </a>
                </li>              
               
                <li>
                  <a href="<?php echo base_url(); ?>poojaPriceListing" >
                    <i class="fa fa-circle-o"></i>Pooja Pricing 
                  </a>
                </li>
            ...
            <li class="treeview">
              <!-- <a href="#" > -->
              <a href="<?php echo base_url(); ?>reportCalendar" >
