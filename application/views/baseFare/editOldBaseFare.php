...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Add / Edit Puja Price</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Puja Price Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <form role="form" id="addNewBaseFare" action="<?php echo base_url() ?>updateOldBaseFare" method="post" role="form">
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="baseFareHour">Hourly Price</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="baseFareDay">Daily Price</label>
